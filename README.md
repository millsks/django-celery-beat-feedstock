...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-celery-beat-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-celery-beat-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-celery-beat
# for installing globally
pixi global install django-celery-beat
```
...
It is possible to list all of the versions of `django-celery-beat` available on your platform:
...
```
pixi search django-celery-beat --channel conda-forge
```
